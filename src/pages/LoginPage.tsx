...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error(
        'Please connect to Supabase first. Click "Connect to Supabase" in the top right corner.'
      );
      return;
    }
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-br from-primary-50 to-primary-100 py-12 px-4 sm:px-6 lg:px-8">
      {/* Content Center */}
      ...
      <div className="text-center py-4 text-sm text-gray-500">
        Created by <span className="font-semibold text-primary-600">Shahid Shaikh</span>
      </div>
    </div>
  );
};
