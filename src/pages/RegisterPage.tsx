...
  // UPDATED: Added upi_id to mosqueDetails state
  const [mosqueDetails, setmosqueDetails] = useState({ name: '', address: '', monthly_amount: '500', upi_id: '' });
...
        address: mosqueDetails.address,
        upi_id: mosqueDetails.upi_id, // ADDED upi_id
...
              
              {/* NEW: UPI ID Field */}
              <input type="text" placeholder="UPI ID (e.g., yourname@upi)" required value={mosqueDetails.upi_id} onChange={(e) => setmosqueDetails({ ...mosqueDetails, upi_id: e.target.value })} className="input-field" />
              
              <div>
