...
const SuperAdminDashboard = () => {
    ...
    return (_jsxs("div", { children: [_jsx(Navbar, {}), _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsxs("div", { className: "mb-8", children: [_jsxs("h1", { className: "text-3xl font-bold text-gray-900", children: ["Welcome, ", user?.full_name || 'Admin'] }), _jsx("p", { className: "text-gray-600 mt-2", children: "Super Admin Dashboard | National Overview" })] }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 mb-8", children: [_jsxs("div", { className: "card text-center", children: [_jsx(Building, { className: "h-8 w-8 mx-auto text-primary-600 mb-2" }), _jsx("p", { className: "text-3xl font-bold text-gray-900", children: totals?.total_mosques.toLocaleString() || 0 }), _jsx("p", { className: "text-gray-500", children: "Total Mosques" })] }), _jsxs("div", { className: "card text-center", children: [_jsx(Users, { className: "h-8 w-8 mx-auto text-primary-600 mb-2" }), _jsx("p", { className: "text-3xl font-bold text-gray-900", children: totals?.total_households.toLocaleString() || 0 }), _jsx("p", { className: "text-gray-500", children: "Total Households" })] }), _jsxs("div", { className: "card text-center", children: [_jsx(Users, { className: "h-8 w-8 mx-auto text-indigo-500 mb-2" }), _jsx("p", { className: "text-3xl font-bold text-gray-900", children: totals?.total_population.toLocaleString() || 0 }), _jsx("p", { className: "text-gray-500", children: "Total Population" })] }), _jsxs("div", { className: "card text-center", children: [_jsx(UserCheck, { className: "h-8 w-8 mx-auto text-primary-600 mb-2" }), _jsx("p", { className: "text-3xl font-bold text-gray-900", children: totals?.total_admins.toLocaleString() || 0 }), _jsx("p", { className: "text-gray-500", children: "Total City Admins" })] }), _jsxs("div", { className: "card text-center", children: [_jsx(IndianRupee, { className: "h-8 w-8 mx-auto text-green-500 mb-2" }), _jsxs("p", { className: "text-3xl font-bold text-gray-900", children: ["\u20B9", totals?.total_collection.toLocaleString() || 0] }), _jsx("p", { className: "text-gray-500", children: "Collection (This Year)" })] })] }), statsByState.length > 0 && (_jsx("div", { className: "card mb-8", children: _jsx(Bar, { options: chartOptions, data: chartData }) })), _jsxs("div", { className: "card", children: [_jsxs("h2", { className: "text-xl font-semibold text-gray-900 mb-6 flex items-center", children: [_jsx(Map, { className: "h-6 w-6 mr-3 text-primary-600" }), "Statistics by State"] }), _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "min-w-full", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "State" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Mosques" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Households" }), _jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "City Admins" }), _jsx("th", { className: "relative px-6 py-3", children: _jsx("span", { className: "sr-only", children: "View" }) })] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: statsByState.map((stat) => (_jsxs("tr", { onClick: () => handleStateClick(stat.state), className: "hover:bg-gray-50 cursor-pointer", children: [_jsx("td", { className: "px-6 py-4 whitespace-nowrap font-medium text-gray-900", children: stat.state }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-gray-600", children: stat.mosque_count }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-gray-600", children: stat.household_count }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-gray-600", children: stat.city_admin_count }), _jsx("td", { className: "px-6 py-4 whitespace-nowrap text-right text-sm font-medium", children: _jsx(ChevronRight, { className: "h-5 w-5 text-gray-400" }) })] }, stat.state))) })] }) }), statsByState.length === 0 && !loading && (_jsxs("div", { className: "text-center py-8", children: [_jsx(Map, { className: "h-12 w-12 text-gray-400 mx-auto mb-4" }), _jsx("p", { className: "text-gray-500", children: "No data found for any state." })] }))] })] })] }));
};
