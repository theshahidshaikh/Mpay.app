...
import { History, Calendar, IndianRupee, CreditCard, Download, Filter, ArrowLeft, CheckCircle, Receipt } from 'lucide-react';
...
const PaymentHistoryPage = () => {
    ...
    const getPaymentMethodIcon = (method) => {
        switch (method.toLowerCase()) {
            ...
            case 'cash':
                return _jsx(IndianRupee, { className: "h-4 w-4" });
            default:
                return _jsx(CreditCard, { className: "h-4 w-4" });
        }
    };
